...
# Time-stamp: <pdc 1999-03-01>
set version 1.06
wm title . "Aviemore Pictures $version"
wm iconname . Aviemore
...
proc findPersonCmd {} {
    ...
    toplevel $w
    wm title $w {Find person -- Damian's Aviemore Pictures}
...
proc findPersonOkCmd {w} {
	...
	tk_dialog .message {Aviemore Pictures} {No names selected.} \
		Warning 0 Dismiss
	return
    }
    destroy $w
