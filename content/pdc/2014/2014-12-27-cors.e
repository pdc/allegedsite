...
[Django’s `static` template-tag][1]).
...
entirely separate [Content Security Policy][2] proposal.
...
The solution is of course to read all of the [W3C Recommendation CORS][3]
(warning: violently horrible use of coloured typography) and parts of
[RFC 6454: The Web Origin Concept][4], digest it all and eventually deduce that
what you need to do to restore the previous _status quo_ is add the following
...
[Enable CORS][6] site has a [more elaborate sample config][5].
