<!-- -*-HTML-*- -->
<entry date="20021103" icon="../icon-64x64.png">
  <h>London calling</h>
  <body>
    <p>
      ...
      Kapoor&rsquo;s giant red sculpture in the Tate Modern</a>
      (<a
      href="http://www.unilever.co.uk/news/anishkapoor.html">this year&rsquo;s
      ...
      rammed in to the Turbine Hall and almost didn&rsquo;t fit.  The
    ...
    <p>
      ...
      visited&mdash;even the route from the tube stop to the entrance
      was different&mdash;using similar white creamy stone to the
    ...
    <p>
      ...
      Tyson</a>&rsquo;s collection of poster-sized sketches of crazy
      ...
      patently not the case Keith Tyson&rsquo;s idea-posters.)  His
      three-dimensional works start in poster form&mdash;in this case
      he had the diagram for <cite>The Thinker (After Rodin)</cite>
      and the sculpture itself in the same room.  His
      <cite>Thinker</cite> is sort of the reverse of Rodin&rsquo;s:
  ...
  <dc:subject>marsyas</dc:subject>
  <dc:subject>anishkapoor</dc:subject>
