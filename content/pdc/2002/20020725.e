<!-- -*-HTML-*- -->
<entry date="20020725" icon="../tarot/xii-hanged-64x64.png"
href="../tarot/">
  <h>No text-transform in SVG</h>
  <body>
    <p>
      Because my <a href="01.html#e20020106">font</a> is
      all-lower-case, I tried using the <code>text-transform</code> 
