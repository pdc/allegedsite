<!-- -*-HTML-*- -->
<entry date="20020129" icon="tarot/v-pope-64x64.png">
  <h>Alleged Tarot (5): Emperor and Pope</h>
  <body>
    <p>
      In the latest installment of the 
      <a href="tarot/">Alleged Tarot 2002</a>
      I&nbsp;have decided to try to reward people visiting in SVG by
      adding a couple of pointless details
      to <a href="tarot/iiii-emperor-svg.html">the Emperor</a> and <a
      href="tarot/v-pope-svg.html">the Pope</a> that cannot be seen
      without zooming in!  
    </p>
    ...
    <p>
      ...
      automated  colour
      correction step; until I&nbsp;manage that, the Pope&rsquo;s lawn
      is a bit garish....
    </p>
  </body>
