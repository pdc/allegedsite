<!-- -*-HTML-*- -->
<entry date="20021008" icon="../icon-64x64.png">
  ...
  <body>
    ...
    <p>
      Alas!  What photos I took are on <a
      href="http://www.shareable.org/">Jamie Lokier</a>&rsquo;s
      digital camera in far-off Bristol.  Well, I&nbsp;say far-off,
      but in Canadian terms it&rsquo;s trivial, of course.
    </p>

    <p>
      I&nbsp;managed to throw my back out getting the suitcases lined
      up ready for driving to the flight home&mdash;one moment
      ...
      Still, <a
      href="http://cleanskies.livejournal.com/57766.html">I&nbsp;am
