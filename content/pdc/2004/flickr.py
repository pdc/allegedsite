...
class Photo(object):
    ...
    dateuploaded = property(lambda self: self._general_getattr("dateuploaded"))
    ...
    cancomment = property(lambda self: self._general_getattr("cancomment"))
    canaddmeta = property(lambda self: self._general_getattr("canaddmeta"))
    ...
    def _general_getattr(self, var):
        ...
        if (
            getattr(self, "_%s__%s" % (self.__class__.__name__, var)) is None
    ...
    def setMeta(self, title=None, description=None):
        ...
        _doget(
            method, auth=True, title=title, description=description, photo_id=self.id
        )
