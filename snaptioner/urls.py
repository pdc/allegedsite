...
urlpatterns = patterns('alleged.snaptioner.views',
    (r'^albums/$', 'album_list', essential_args, 'album_list'),
    (r'^albums/(?P<album_name>[a-z0-9-]+)/$', 'album_detail', essential_args, 'album_detail'),
    (r'^albums/(?P<album_name>[a-z0-9-]+)/(?P<image_name>[a-z0-9.-]+)$', 'image_detail', essential_args, 'image_detail')
    ##,
